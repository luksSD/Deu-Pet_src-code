...
public class Constants {
    ...
    public static final String ENDPOINT = "http://deupet-api.us-east-1.elasticbeanstalk.com/api/v1/";
//    public static final String ENDPOINT = "http://localhost:5005/api/v1/";
    public static final String DOWNLOAD_USER_FILE_ENDPOINT = ENDPOINT + "files/download-user-file/";
